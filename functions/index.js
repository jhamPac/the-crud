...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=require("../firebaseSingleton");const o=t.admin.firestore();console.log(o);const e=[{id:1,firstName:"Tom",lastName:"Coleman"},{id:2,firstName:"Sashko",lastName:"Stubailo"}],r=[{id:1,authorId:1,title:"Introduction to GraphQL",votes:2},{id:2,authorId:2,title:"GraphQL Rocks",votes:3},{id:3,authorId:2,title:"Advanced GraphQL",votes:1}],i={Query:{posts:()=>r,author:(t,{id:o})=>e.find(t=>t.id===o)},Mutation:{upvotePost(t,{postId:o}){const e=r.find(t=>t.id===o);if(!e)throw new Error(`Couldn't find post with id ${o}`);return e.votes+=1,e}},Author:{posts:t=>r.filter(o=>o.authorId===t.id)},Post:{author:t=>e.find(o=>o.id===t.authorId)}};var d=i;exports.default=d;

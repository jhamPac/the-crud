...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.api=void 0;var e=require("apollo-server-cloud-functions"),r=o(require("./graphql/schema")),i=Object.assign||function(e){for(var r=1;r<arguments.length;r++){var i=arguments[r];for(var o in i)Object.prototype.hasOwnProperty.call(i,o)&&(e[o]=i[o])}return e};function o(e){return e&&e.__esModule?e:{default:e}}const t=require("firebase-admin"),s=require("firebase-functions"),n=require("express"),a=require("cors"),c=require("os");function u(){const e=require(`${c.homedir()}/.firebase/keyfile.json`);return{credential:t.credential.cert(e),databaseURL:"https://blackjynxy.firebaseio.com"}}const l=process.env.LOCAL_TEST?u():s.config().firebase;t.initializeApp(l);const p=t.firestore(),f=new e.ApolloServer(i({},r.default,{playground:!0})),d=s.https.onRequest(f.createHandler({cors:{origin:"*"}}));exports.api=d;

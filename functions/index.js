...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.vulcan=exports.api=void 0;var e=require("./firebaseSingleton"),r=require("apollo-server-cloud-functions"),o=n(require("./graphql/schema")),t=Object.assign||function(e){for(var r=1;r<arguments.length;r++){var o=arguments[r];for(var t in o)Object.prototype.hasOwnProperty.call(o,t)&&(e[t]=o[t])}return e};function n(e){return e&&e.__esModule?e:{default:e}}const s=new r.ApolloServer(t({},o.default,{playground:!0})),i=e.functions.https.onRequest(s.createHandler({cors:{origin:"*"}}));exports.api=i;const a=e.functions.firestore.document("provisions/food").onWrite((e,r)=>{console.log(e,"jeah")});exports.vulcan=a;
